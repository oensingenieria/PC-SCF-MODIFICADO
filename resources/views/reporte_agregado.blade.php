...
<div class="row">
	<div class="col-md-12">
	 ...
	 <div class="col-md-2" >
	 	...
	 	<a class="btn btn-info btn-block buttonnavlef" style="background-color: #FFF;border-color: rgb(32, 62, 155);margin-bottom: 10px;color: blue; " href="/pc/reportes/consumo/agregado">Consumo Agregado</a>
...
var pieData = [{value: 40,color:"#0b82e7",highlight: "#0c62ab",label: "Google Chrome"},
	...
	var barChartData = {
		labels : ["V. Conreto","C. UG-AR","Arena CM","Arena MG","Quinta ME","Ad. plastol","Visctrol","Eucon"],
		datasets : [
			{
				fillColor : "#6b9dfa",
				strokeColor : "#ffffff",
