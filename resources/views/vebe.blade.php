...
<?php
	 ...
	 function getVebe1($carga , $compara) { 
    
    foreach ($compara as $vebe) {
    	
    	if($vebe->Vebe_Carga == $carga){
    		return $vebe->Vebe1;
    	}
    }
    ...
    function getTarro1($carga , $compara) { 
    ...
    foreach ($compara as $vebe) {
	 ...
	 function getVebe2($carga , $compara) { 
    ...
    function getTarro2($carga , $compara) { 
    ...
    foreach ($compara as $vebe) {
	 ...
	 function getVebe3($carga , $compara) { 
    ...
    function getTarro3($carga , $compara) { 
   ...
   function exist_vebe($carga , $compara) { 
    $pass= false;
    foreach ($compara as $vebe) {
	...
	<button style="margin-right:20px" class="btn btn-info pull-right" data-remodal-target="infovebe_modal" > <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span></button>
		...
		<div class="col-md-12 ">
			<div class="panel panel-default">
				<div class="panel-heading text-center">  <b>VEBE</b></div>
  	...
  	<div class="col-md-12">
  	 ...
  	 <table class="table table-bordered" >
  		...
  		<thead class="bg-success">
				      ...
				      <tr>
				      <td ><input type="text" readonly="" name="Vebe_Carga" id="numerocarga" class="form-control pull-left" ></td>
				        <td><select name="Tarro1" class="form-control" > 
				        ...
				        <option value="Tarro 12">Tarro 12</option>
				          ...
				          <td><select name="Tarro2" class="form-control" > 
				        <option value="Tarro 1">Tarro 1</option>
				        <option value="Tarro 2">Tarro 2</option>
				        <option value="Tarro 3">Tarro 3</option>
				        <option value="Tarro 4">Tarro 4</option>
				        ...
				        <option value="Tarro 12">Tarro 12</option>
				          ...
				          <td><select name="Tarro3" class="form-control" > 
				        <option value="Tarro 1">Tarro 1</option>
				        <option value="Tarro 2">Tarro 2</option>
				        <option value="Tarro 3">Tarro 3</option>
				        <option value="Tarro 4">Tarro 4</option>
		 ...
		 <tbody>
				   ...
				   <tr>
				   	 ...
				   	 <td><select name="Mezcla1" class="form-control" > 
				        <option value="E">E</option>
				        <option value="W">W</option>
				       </select></td>

				   <td>	 <select name="Mezcla2" class="form-control" > 
				        <option value="E">E</option>
				        <option value="W">W</option>
				       </select></td>
				   	 
				   <td>	 <select name="Mezcla3" class="form-control" > 
				        <option value="E">E</option>
				        <option value="W">W</option>
				       </select></td>
				   ...
				   <tr>
				   	 ...
				   	 <td><select name="Peralte1" class="form-control" > 
				        <option value="20">20</option>
				        <option value="25">25</option>
				       </select></td>

				   <td>	 <select name="Peralte2" class="form-control" > 
				        <option value="20">20</option>
				        <option value="25">25</option>
				       </select></td>
				   	 
				   <td>	 <select name="Peralte3" class="form-control" > 
				        <option value="20">20</option>
				        <option value="25">25</option>
				       </select></td>
