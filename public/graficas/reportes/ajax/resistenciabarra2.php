...
<script type="text/javascript">
    $(function() {
        $('#fallass').highcharts({
            ...
            title: {
                text: 'Falla a 7 días por tipo de diseño <br> (<?php echo $nombresme.' '.date('Y');?>)'
            },
            yAxis: {
                allowDecimals: false,
                title: {
...
<div id="fallass" style="min-width: 300px; height: 400px; margin: 0 auto">
</div>
<div style="display: none;">
    ...
    <table id="fallas">
        ...
        <tr>
            ...
            ?>
            <td><?php echo $resistencia7[0]['miin']; ?></td>
            <td><?php echo $resistencia7[0]['maax'];
                }?></td>
        </tr>
