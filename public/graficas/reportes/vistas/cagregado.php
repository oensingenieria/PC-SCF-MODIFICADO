...
<div class="row setup-content" id="step-1">
    <form id="form-step-1" class="form-step-1" enctype="multipart/form-data">
        <div class="bv_reportes">Reportes de Consumo de Agregado</div>
        <table style="width: 100%">
            ...
            <tr>
                <td>
                    <select name="ensayo" id="ensayo" class="form-control">
                        ...
                        <?php foreach ($materiales as $row) { ?>
                            <option value='<?php echo $row['Codigo_Material'] ?>'>
                                <?php echo $row['nombre_material']; ?>
                            <?php } ?>
                ...
                <td>
                    <a id="buscar_mes_agregado" class="boton_reportes_1 btn btn-primary btn-lg">Buscar</a>
                </td>
            </tr>
        </table>
    </form>
